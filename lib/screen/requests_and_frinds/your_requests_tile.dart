...
class YourRequestsListTile extends StatefulWidget {
  Map<String, dynamic> data;
  YourRequestsListTile(this.data, {Key? key}) : super(key: key);

  @override
  State<YourRequestsListTile> createState() => _YourRequestsListTileState();
}

class _YourRequestsListTileState extends State<YourRequestsListTile> {
  @override
  Widget build(BuildContext context) {
    return widget.data['request'] == 'req'
        ? myCard()
        : Container(
            height: 0,
          );
