...
class SearchTilePost extends StatefulWidget {
  Map<String, dynamic> data;
  SearchTilePost(this.data, {Key? key}) : super(key: key);

  @override
  State<SearchTilePost> createState() => _SearchTilePostState();
}

class _SearchTilePostState extends State<SearchTilePost> {
  @override
  Widget build(BuildContext context) {
    return widget.data['showMode'][0] == 'showForAll'
        ? myCard()
        : Container(
            height: 0,
          );
